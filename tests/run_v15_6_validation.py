...
app=(r/'app.js').read_text(); api=(r/'fitness_backend_api_v2_connected.py').read_text(); db=(r/'database.py').read_text(); mod=(r/'js/forge_notifications.js').read_text(); idx=(r/'index.html').read_text()
...
assert 'ForgeNotifications.permission()' in app
assert 'ForgeNotifications.deliver' in app
