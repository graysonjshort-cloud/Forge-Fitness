...
assert meta['version']=='15.11.0' and meta['feature_freeze'] is False
assert '/release' in api and 'architecture-hardening' in api
assert 'forge-v15-11-modularization-v1' in sw
