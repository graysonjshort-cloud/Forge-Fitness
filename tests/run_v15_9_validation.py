...
idx=(r/'index.html').read_text(); css=(r/'styles.css').read_text(); mob=(r/'js/forge_mobile.js').read_text(); app=(r/'app.js').read_text()
...
assert 'visualViewport' in mob and 'scrollIntoView' in mob and 'ForgeMobile.loading' in app
